...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .d-flex.mb-5
      img(src="@/assets/curso/tema2/decorador.svg" style="max-width: 36px").mx-3.mx-md-4
    ...
    .d-flex.justify-content-between.mb-5
      img(src="@/assets/curso/tema2/decorador4.svg" style="max-width: 35px").mx-3
      ...
      img(src="@/assets/curso/tema2/decorador4.svg" style="max-width: 35px").mx-3.d-none.d-lg-flex
