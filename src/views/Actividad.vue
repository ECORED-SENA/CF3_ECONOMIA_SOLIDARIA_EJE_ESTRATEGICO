    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      .col-6.col-md-4.col-lg-3.mb-4.mb-md-0
        .tarjeta.h-100.d-flex.align-items-center
          figure
            img(src="@/assets/curso/actividad1.svg", alt="Texto que describa la imagen")
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Constitución de empresas de economía solidaria.
        p.mb-4 Apropiar el conocimiento en la identificación de los pasos para la constitución de empresas de economía solidaria.
