...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    ImagenInfograficaB.color-primario.mb-5.img-modal-1
      ...
      div(x="20%" y="65%" tooltip="Superintendencia de la economía social" numero="")
        ...
        .ps-0.ps-md-5
          ...
          .d-flex.flex-wrap.flex-md-nowrap.ps-0.ps-md-5.ms-0.ms-md-5.mb-4
            .d-flex.flex-wrap
              p(style="color: black !important") Los valores corporativos de la Supersolidaria se articulan a los principios corporativos establecidos en el marco conceptual de las organizaciones de economía solidaria, entre los que se encuentran:
              p(style="color: black !important").pe-5 - Honestidad. <br>
                | - Justicia. <br>
                | - Diligencia <br>
              p(style="color: black !important") - Respeto. <br>
                | - Compromiso. <br>
                | - Solidaridad. <br>
    ...
    .d-flex.mb-0
      img(src="@/assets/curso/tema3/decorador7.svg" style="max-width: 10px").me-3
      p.fw-bold.mb-0 Figura 3
    p.ms-4.mb-5 <em>Trámites ante la Superfinanciera</em>
